...
// Function returns {obj:key, ...} , based on state, first and second value
// style_ = [{background:'blue',s:state$,v:'white'},
//            {color:'black',s:state$, v:'yellow'}]
export var reStyle$ = (StyleArray) => {
    let result = {}
    for(let i in StyleArray){
        let object_ = StyleArray[i]
        result = Object.values(object_)[1] ? {...result,[Object.keys(object_)[0]] : Object.values(object_)[2]} : {...result, [Object.keys(object_)[0]] : Object.values(object_)[0]}
        }
    return result
}
